...
<div class="input-group mb-3 has-validation">
    ...
    <!-- this will catch the failed validation messages -->
</div>
...
<div class="input-group mb-3 has-validation">
    ...
    <input type="text" class="form-control @if ($errors->first('email')) is-invalid @endif"
           placeholder="Insert email here..." aria-label="Name" aria-describedby="basic-addon1" name="email"
...
<div class="form-group mb-3 has-validation">
    <select name="active" class="form-control @if ($errors->first('active')) is-invalid @endif"
